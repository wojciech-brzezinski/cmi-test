...
(function () {
  return __awaiter(this, void 0, void 0, function () {
    var section, comments, _i, comments_1, comment;

    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          section = document.querySelector("[data-section-last-comments]");
          return [4
          /*yield*/
          , GetComments()];
        ...
        case 1:
          ...
          for (_i = 0, comments_1 = comments; _i < comments_1.length; _i++) {
            ...
            section.appendChild(article_comments_section_1.CreateCommentElement(comment));
          }
